...
DietView = Literal["today_diet", "food_library", "supplement_library"]

TODAY_DIET_VIEW: Final[DietView] = "today_diet"
FOOD_LIBRARY_VIEW: Final[DietView] = "food_library"
SUPPLEMENT_LIBRARY_VIEW: Final[DietView] = "supplement_library"
...
DIET_VIEW_LABELS: Final[dict[DietView, str]] = {
    ...
    SUPPLEMENT_LIBRARY_VIEW: "补剂库",
}

LEGACY_DIET_VIEW_MAP: Final[dict[str, DietView]] = {
    "diet": TODAY_DIET_VIEW,
    "foods": FOOD_LIBRARY_VIEW,
    "supplements": SUPPLEMENT_LIBRARY_VIEW,
    TODAY_DIET_VIEW: TODAY_DIET_VIEW,
    FOOD_LIBRARY_VIEW: FOOD_LIBRARY_VIEW,
    SUPPLEMENT_LIBRARY_VIEW: SUPPLEMENT_LIBRARY_VIEW,
}

RECOVERY_SUPPLEMENT_SURFACES: Final[tuple[str, ...]] = ("today_supplements",)
...
def diet_route_for_view(view: str | None) -> str:
    ...
    if active == FOOD_LIBRARY_VIEW:
        return "foods"
    if active == SUPPLEMENT_LIBRARY_VIEW:
        return "supplements"
    return "diet"
