...
- 源码 PR [#9](https://github.com/fivespeedbuck/carbs-king/pull/9) 已合并到 `main`。
- `v1.2.3` Release 已更新为 Build 80，仅保留 `carbs_king.apk`。
- 远端资产状态为 `uploaded`，大小 `201,668,355` 字节，digest 为 `sha256:7590eee32cfa94ee8595c45a872de3397fc0751261887b39f44bfa7588c82644`。
